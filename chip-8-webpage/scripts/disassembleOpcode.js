...
// let tempIndex = 0;
// let xorDisplay = display.map(function(value) {
//   value = value ^ tempDisplay[tempIndex++];
//   return value;
// };

// let collisionRegister = false;

// ///// Same as above /////
// let xorDisplay = new Array(numberOfPixels);
// for (let i = 0; i < xorDisplay.length; i++) {
//   xorDisplay[i] = display[i] ^ tempDisplay[i];
//   if (display[i] === 1 && tempDisplay[i] === 1)
//     collisionRegister = true;
// }

// console.log(xorDisplay);
// console.log(collisionRegister);

// let p = [0xF0, 0x90, 0x90, 0x90, 0xF0];
// let s = p.map(x => x.toString(2));
...
// function drawByte(x, y, byteToDraw) {
//   let screenX = x;
//   let screenY = x + 64*y;
  
//   let tempDisplay = new Array(numberOfPixels);
//   tempDisplay.fill(0);
